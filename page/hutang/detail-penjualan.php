...
<!--Bagian heading -->
<h1 class="h3 mb-2 text-gray-800">Detail Penjualan Hutang</h1>
<p class="mb-4">Halaman detail penjualan berisi informasi seluruh penjualan yang dilakukan secara kredit/hutang dapat di kelolah oleh admin.</p>
        ...
        <div>
            <div class="col-sm-12">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td colspan="5" style="text-align:right"><strong>Total Bayar Setelah Diskon</strong></td> <td><strong>Rp. <?php echo number_format($total_bayar_diskon,0,',','.');  ?></strong></td>
                    </tr>
                    <tr>
                        <td colspan="5" style="text-align:right"><strong>Uang Muka</strong></td> <td><strong>Rp. <?php echo number_format($uang_muka,0,',','.');  ?></strong></td>
                    </tr>
                    <tr>
                        <td colspan="5" style="text-align:right"><strong>Kekurangan</strong></td> <td><strong>Rp. <?php echo number_format($kekurangan,0,',','.');  ?></strong></td>
                    </tr>
                    <tr>
                        <td colspan="5" style="text-align:right"><strong>Keterangan</strong></td> <td><strong>Belum Lunas</strong></td>
                    </tr>
                    </tbody>
                </table>
            </div>
