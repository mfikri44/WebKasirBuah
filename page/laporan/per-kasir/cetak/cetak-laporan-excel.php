<?php
    ...
    header("Content-Disposition: attachment; filename=LAPORAN PENJUALAN PER KASIR ".strtoupper($row['nama_aplikasi'])." ".$tanggal.".xls");
?>  
<h2><center>LAPORAN PENJUALAN PER KASIR <?php echo strtoupper($row['nama_aplikasi']);?></center></h2>
