<?php
    ...
    $pdf->Cell(1.4,0.3,'Produk',0,0,'C');
    $pdf->Cell(0.6,0.3,'Harga',0,0,'C');
    $pdf->Cell(0.4,0.3,'Qty',0,0,'C');
    $pdf->Cell(0.7,0.3,'Sub Total',0,1,'C');
    ...
    while ($ambil = mysqli_fetch_array($hasil)):
        ...
        $pdf->Cell(1.4,0.01,substr($ambil['nama_produk'],0,25),0,0);
        $pdf->Cell(0.6,0.01,'Rp. '.number_format($harga,0,',','.'),0,0,'C');
        $pdf->Cell(0.4,0.01,$ambil['qty'],0,0,'C');
        $pdf->Cell(0.25,0.01,'  Rp. ',0,0,'R');
        $pdf->Cell(0.53,0.01,' '.number_format($sub_total,0,',','.') ,0,0,'R');
        $pdf->Cell(1,0.1,'',0,1);
        $pdf->Ln(0.02);
    ...
    $pdf->Cell(2,0,'-----------------------------------------------------------------------------------------------------',0,1);
    $pdf->Cell(0.1,0.01,'',0,0);
    $pdf->Cell(2.7,0.3,'Total Bayar',0,0,'R');
    $pdf->Cell(0.25,0.3,'  Rp. ',0,0,'L');
    $pdf->Cell(0.63,0.3,' '.number_format($data['total_bayar'],0,',','.') ,0,0,'R');
    $pdf->Ln(0.15);
    $pdf->Cell(0.1,0.01,'',0,0);
    $pdf->Cell(2.7,0.3,'Diskon(-)',0,0,'R');
    $pdf->Cell(0.25,0.3,'  Rp. ',0,0,'L');
    $pdf->Cell(0.63,0.3,' '.number_format($data['diskon'],0,',','.') ,0,0,'R');
    $pdf->Ln(0.15);
    $pdf->Cell(0.1,0.01,'',0,0);
    $pdf->Cell(2.7,0.3,'Ongkos Kirim',0,0,'R');
    $pdf->Cell(0.25,0.3,'  Rp. ',0,0,'L');
    $pdf->Cell(0.63,0.3,' '.number_format($data['ongkos_kirim'],0,',','.') ,0,0,'R');
    $pdf->Ln(0.25);
    $pdf->Cell(2,0,'-----------------------------------------------------------------------------------------------------',0,1);
    $pdf->Cell(0.1,0.01,'',0,0);
    $pdf->Cell(2.7,0.3,'Total Transaksi',0,0,'R');
    $pdf->Cell(0.25,0.3,'  Rp. ',0,0,'L');
    $pdf->Cell(0.63,0.3,' '.number_format($data['total_transaksi'],0,',','.') ,0,0,'R');
    $pdf->Ln(0.3);
    $pdf->Cell(2,0,'-----------------------------------------------------------------------------------------------------',0,1);
