...
?>
    <form action="page/supplier/edit-supplier.php" method="post">
            ...
            <div class="form-group">
                ...
                <input name="nama_supplier" value="<?php echo $nama_supplier; ?>" type="text" class="form-control" placeholder="Masukan nama" required>
            </div>
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                      <label>No Telp:</label>
                      <input name="no_telp" type="text" value="<?php echo $no_telp; ?>" class="form-control" placeholder="Masukan no telp" required>
                  </div>
                </div>
            </div>
